...
export default function About () {
  ...
  return (
    <section id="about" className="py-10 md:py-0 md:min-h-screen min-w-full flex justify-center flex-col md:flex-row">
      <h1 id="about-me-mobile" className="md:hidden text-2xl sticky top-0 z-50 w-full py-4 px-8 bg-retro-lightyellow/90">About me</h1>
      <div className="max-w-7xl w-full flex flex-col md:flex-row items-center gap-18 md:gap-6 px-4 justify-center">
        <div className="md:flex-1 flex flex-col items-center md:items-start justify-center gap-4 md:gap-10 md:h-full px-4">
          ...
          <h1 id="about-me-desktop" className="text-2xl md:text-4xl md:static md:z-0 md:bg-transparent md:w-auto md:px-0 md:py-0 md:block hidden">About me</h1>

          <p className="about-description md:text-xl font-turret-road font-bold">
